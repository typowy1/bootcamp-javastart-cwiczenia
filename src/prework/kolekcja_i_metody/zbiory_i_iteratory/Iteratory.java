...
public class Iteratory {
    public static void main(String[] args) {
        ...
        // iterator usówamy, zmieniamy stan, iterujemy po zbiorach, mozna tez po kolekcjach
        //w przypadku wszystkich kolekcji mam dostęp do metody zwanej iterator()
        //terator<Book> iterator = books.iterator(); iterator, pozwoli przejżeć wszystkie obiekty znajdujące sie w danej kolekci
